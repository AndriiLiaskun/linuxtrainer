...
const COMMAND_DOCS = {
  ...
  find: { desc: 'Шукає файли за іменем/типом у дереві директорій.', opts: [['-name', 'шаблон імені', "find . -name '*.log'"], ['-type f/d', 'файл чи директорія', 'find . -type d']], example: "find . -name '*.log'" },
