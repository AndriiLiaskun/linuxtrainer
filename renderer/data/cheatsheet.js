...
const CHEATSHEET = [
  ...
  { icon: '🔐', title: 'Права та користувачі', cmds: [c('chmod'), c('chown'), c('stat'), c('umask'), c('sudo'), c('su'), c('passwd'), c('useradd'), c('userdel'), c('groupadd'), c('groupdel'), c('who'), c('last')] },
  ...
  { icon: '⚡', title: 'Процеси', cmds: [c('ps'), c('top'), c('htop'), c('kill'), c('jobs'), c('free'), c('df'), c('du'), c('uptime'), c('watch'), c('lsof')] },
  { icon: '🛠️', title: 'systemd', cmds: [c('systemctl'), c('journalctl')] },
  { icon: '🌐', title: 'Мережа', cmds: [c('ping'), c('curl'), c('wget'), c('ssh'), c('scp'), c('dig'), c('nslookup'), c('ss'), c('netstat'), c('ip'), c('rsync'), c('traceroute')] },
