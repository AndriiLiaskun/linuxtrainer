...
const CHEATSHEET = [
  ...
  { icon: '🔐', title: 'Права та користувачі', cmds: [c('chmod'), c('chown'), c('chgrp'), c('stat'), c('umask'), c('sudo'), c('su'), c('visudo'), c('passwd'), c('useradd'), c('adduser'), c('userdel'), c('usermod'), c('groupadd'), c('groupdel')] },
