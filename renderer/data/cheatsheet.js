...
const CHEATSHEET = [
  ...
  { icon: '🔐', title: 'Права доступу', cmds: [c('chmod'), c('chown'), c('stat'), c('umask')] },
  { icon: '🔍', title: 'Пошук', cmds: [c('grep'), c('find')] },
  { icon: '⚙️', title: 'Обробка тексту', cmds: [c('sed'), c('awk'), c('sort'), c('cut'), c('tr'), c('xargs'), c('uniq')] },
  { icon: '📜', title: 'Скрипти', cmds: [c('echo'), c('export'), c('for'), c('if'), c('$(...)'), c('sleep'), c('history')] },
  { icon: '⚡', title: 'Процеси', cmds: [c('ps'), c('top'), c('kill'), c('jobs'), c('free'), c('df'), c('du'), c('uptime')] },
  { icon: '🛠️', title: 'systemd', cmds: [c('systemctl'), c('journalctl')] },
  { icon: '🌐', title: 'Мережа', cmds: [c('ping'), c('curl'), c('wget'), c('ssh'), c('scp'), c('dig'), c('nslookup'), c('ss'), c('netstat')] },
  { icon: '📦', title: 'Пакети', cmds: [c('apt'), c('yum'), c('dnf')] },
  { icon: '🖥️', title: 'Система', cmds: [c('whoami'), c('id'), c('hostname'), c('date')] },
  {
    icon: '🔧',
    title: 'Git',
    cmds: [
